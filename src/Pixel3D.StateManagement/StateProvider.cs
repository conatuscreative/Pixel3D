...
namespace Pixel3D.StateManagement
{
	...
	public class StateProvider
	{
		...
		private static void SetupStateTypeRecursive(Dictionary<Type, State> states,
			Dictionary<Type, MethodTable> abstractStates,
		...
		{
			throw new Exception("Method signature does not match: \"" + methodInStateMachine +
			                    "\" cannot be used for \"" + methodInMethodTable + "\"");
		}
