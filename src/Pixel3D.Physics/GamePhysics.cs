...
{
    // Inheritance here isn't ideal, but we need some physics stuff (collisions) to be accessible by Pixel3D
    public class GamePhysics : WorldPhysics
    {
        ...
        internal void ProcessStackedMotion(RCRUUpdateContext updateContext)
        {
