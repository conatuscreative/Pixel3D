...
namespace Pixel3D.Levels
{
	public class LevelBehaviour
	{
		...
		public virtual void BeforeUpdate(UpdateContext updateContext)
		{
			...
			foreach (var subBehaviour in subBehaviours) subBehaviour.BeforeUpdate(updateContext);
		}
		...
		public virtual void AfterUpdate(UpdateContext updateContext)
		{
			...
			foreach (var subBehaviour in subBehaviours) subBehaviour.AfterUpdate(updateContext);
		}
		...
		public virtual void AfterDraw(DrawContext drawContext)
		{
			...
			foreach (var subBehaviour in subBehaviours) subBehaviour.AfterDraw(drawContext);
		}
		...
		public virtual void BeforeBackgroundDraw(DrawContext drawContext)
		{
			...
			foreach (var subBehaviour in subBehaviours) subBehaviour.BeforeBackgroundDraw(drawContext);
		}
		...
		public virtual void PlayerDidLeave(UpdateContext updateContext, int playerIndex)
		{
			...
			foreach (var subBehaviour in subBehaviours) subBehaviour.PlayerDidLeave(updateContext, playerIndex);
		}
		...
		public virtual void PlayerDidJoin(UpdateContext updateContext, int playerIndex)
		{
			...
			foreach (var subBehaviour in subBehaviours) subBehaviour.PlayerDidJoin(updateContext, playerIndex);
		}
